                                ...
                                <div class="mb-2">
                                    ...
                                    <div class="d-flex align-items-center flex-wrap">
                                        <p class="fs-14 mb-2 me-3 pe-3 border-end d-flex align-items-center">
                                            <img src="assets/img/icons/airindia.svg" class="me-2" alt="Img"> Air India
                                ...
                                <div class="slider-wrap">
                                    <div class="owl-carousel service-carousel nav-center mb-4" id="large-img">
                                        <div class="service-img">
                                            <img src="assets/img/flight/flight-large-01.jpg" class="img-fluid" alt="Slider Img">
                                        </div>
                                        <div class="service-img">
                                            <img src="assets/img/flight/flight-large-02.jpg" class="img-fluid" alt="Slider Img">
                                        </div>
                                        <div class="service-img">
                                            <img src="assets/img/flight/flight-large-03.jpg" class="img-fluid" alt="Slider Img">
                                        </div>
                                        <div class="service-img">
                                            <img src="assets/img/flight/flight-large-04.jpg" class="img-fluid" alt="Slider Img">
                                        </div>
                                        <div class="service-img">
                                            <img src="assets/img/flight/flight-large-05.jpg" class="img-fluid" alt="Slider Img">
                                        </div>
                                        <div class="service-img">
                                            <img src="assets/img/flight/flight-large-06.jpg" class="img-fluid" alt="Slider Img">
                                        </div>
                                    </div>
                                    <a href="assets/img/flight/flight-large-04.jpg" data-fancybox="gallery" class="btn btn-white btn-xs view-btn"><i class="isax isax-image me-1"></i>See All</a>
                                </div>
                                <div class="owl-carousel slider-nav-thumbnails nav-center" id="small-img">
                                    <div><img src="assets/img/flight/flight-thumb-01.jpg" class="img-fluid" alt="Slider Img"></div>
                                    <div><img src="assets/img/flight/flight-thumb-02.jpg" class="img-fluid" alt="Slider Img"></div>
                                    <div><img src="assets/img/flight/flight-thumb-03.jpg" class="img-fluid" alt="Slider Img"></div>
                                    <div><img src="assets/img/flight/flight-thumb-04.jpg" class="img-fluid" alt="Slider Img"></div>
                                    <div><img src="assets/img/flight/flight-thumb-05.jpg" class="img-fluid" alt="Slider Img"></div>
                                    <div><img src="assets/img/flight/flight-thumb-06.jpg" class="img-fluid" alt="Slider Img"></div>
                                </div>
                            </div>
                        </div>
                    </div>
                                    ...
                                    <div class="hotel-list">
                                            ...
                                            <div class="place-content pb-1">
                                                <div class="d-flex align-items-center justify-content-between flex-wrap">
                                                    <div class="overflow-hidden">
                                                        <h5 class="mb-2 d-inline-flex align-items-center text-truncate"><a href="flight-details.html">Economy Class</a></h5>
                                                    </div>
                                        ...
                                        <div class="place-item mb-4">
                                            ...
                                            <div class="place-content pb-1">
                                                <div class="d-flex align-items-center justify-content-between flex-wrap">
                                                    <div class="overflow-hidden">
                                                        <h5 class="mb-2 d-inline-flex align-items-center text-truncate"><a href="flight-details.html">Business Class</a></h5>
                                                    </div>
                                                    <div class="d-flex align-items-center text-nowrap mb-2">
                                                        <span class="badge badge-warning badge-xs text-gray-9 fs-13 fw-medium me-2">4.3</span>
                                                        <p class="fs-14">(380 Reviews)</p>
                                        ...
                                        <div class="place-item mb-4">
                                            <div class="place-img">
                                                <div class="img-slider owl-carousel nav-center">
                                                    <div class="slide-images">
                                                        <a href="flight-details.html">
                                                            <img src="assets/img/flight/flight-13.jpg" class="img-fluid" alt="img">
                                                        </a>
                                                    </div>
                                                    <div class="slide-images">
                                                        <a href="flight-details.html">
                                                            <img src="assets/img/flight/flight-12.jpg" class="img-fluid" alt="img">
                                                        </a>
                                                    </div>
                                                </div>
                                                <div class="fav-item justify-content-end">
                                            ...
                                            <div class="place-content pb-1">
                                                <div class="d-flex align-items-center justify-content-between flex-wrap">
                                                    <div class="overflow-hidden">
                                                        <h5 class="mb-2 d-inline-flex align-items-center text-truncate"><a href="flight-details.html">Regular</a></h5>
                                                    </div>
                                                    <div class="d-flex align-items-center text-nowrap mb-2">
                                                        <span class="badge badge-warning badge-xs text-gray-9 fs-13 fw-medium me-2">4.3</span>
                                                        <p class="fs-14">(380 Reviews)</p>
                            ...
                            <div id="accordion_collapse_four" class="accordion-collapse collapse show">
                                <div class="accordion-body pt-0">
                                    <div class="row row-cols-lg-6 row-cols-sm-4 row-cols-2 g-2">
                                        <div class="col">
                                            <a class="galley-wrap" data-fancybox="gallery" href="assets/img/flight/flight-large-01.jpg">
                                                <img src="assets/img/flight/flight-thumb-01.jpg" alt="img">
                                            </a>
                                        </div>
                                        <div class="col">
                                            <a class="galley-wrap" data-fancybox="gallery" href="assets/img/flight/flight-large-02.jpg">
                                                <img src="assets/img/flight/flight-thumb-02.jpg" alt="img">
                                            </a>
                                        </div>
                                        <div class="col">
                                            <a class="galley-wrap" data-fancybox="gallery" href="assets/img/flight/flight-large-03.jpg">
                                                <img src="assets/img/flight/flight-thumb-03.jpg" alt="img">
                                            </a>
                                        </div>
                                        <div class="col">
                                            <a class="galley-wrap" data-fancybox="gallery" href="assets/img/flight/flight-large-04.jpg">
                                                <img src="assets/img/flight/flight-thumb-04.jpg" alt="img">
                                            </a>
                                        </div>
                                        <div class="col">
                                            <a class="galley-wrap" data-fancybox="gallery" href="assets/img/flight/flight-large-05.jpg">
                                                <img src="assets/img/flight/flight-thumb-05.jpg" alt="img">
                                            </a>
                                        </div>
                                        <div class="col">
                                            <div class="galley-wrap more-gallery d-flex align-items-center justify-content-center">
                                                <a data-fancybox="gallery" href="assets/img/flight/flight-large-01.jpg" class="btn btn-white btn-xs"><i class="isax isax-image5 me-1"></i>See All</a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                ...
                <div class="col-xl-4 theiaStickySidebar">
                    <div class="card shadow-none">
                        <div class="card-body">
                            ...
                            <div class="banner-form">
                                <form method="POST" class="form-info border-0">
                                    @csrf
                                    @method('POST')
                                    ...
                                    <a type="submit" href="{{route('client.create.reservation')}}" class="btn btn-primary btn-lg search-btn ms-0 w-100 mb-3 fs-14">Book Now</a>
                    ...
                    <div class="card shadow-none mb-0">
                        <div class="card-body">
                            ...
                            <div class="py-1">
                                ...
                                <div class="border br-10 mb-3 p-3">
                                    ...
                                    <div class="d-flex align-items-center border-bottom pb-3 mb-3">
                                        ...
                                        <p><a href="https://dreamstour.dreamstechnologies.com/cdn-cgi/l/email-protection" class="__cf_email__" data-cfemail="2960474f46694c51484459454c074a4644">[email&#160;protected]</a></p>
                                    </div>
                                    <div class="d-flex align-items-center">
                            ...
                            <div class="row g-2">
                                ...
                                <div class="col-sm-6">
                                    <a href="chat.html" class="btn btn-primary d-flex align-items-center justify-content-center"><i class="isax isax-message-notif5 me-2"></i>Chat Now</a>
                                </div>
                            </div>
                        </div>
                    </div> --}}
