                    ...
                    <div class="col-xxl-2 col-lg-3 col-md-4 col-sm-6">
                        <div class="d-flex align-items-center hotel-type-item mb-3">
                            <a href="flight-grid.html" class="avatar avatar-lg">
                                <img src="{{asset('assets/img/flight/flight-company-01.svg')}}" class="rounded-circle" alt="img">
                            </a>
                            <div class="ms-2">
                    ...
                    <div class="d-flex align-items-center justify-content-between flex-wrap">
                        ...
                        <div class="d-flex align-items-center flex-wrap">
                            <div class="list-item d-flex align-items-center mb-3">
                                <a href="flight-grid.html" class="list-icon me-2"><i class="isax isax-grid-1"></i></a>
                                <a href="flight-list.html" class="list-icon active me-2"><i class="isax isax-firstline"></i></a>
                            </div>
                                ...
                                <div class="place-item mb-4">
                                    <div class="place-img">
                                        <div class="img-slider image-slide owl-carousel nav-center">
                                            ...
                                            <div class="slide-images">
                                                <a href="flight-details.html">
                                                    <img src="{{asset('assets/img/flight/flight-02.jpg')}}" class="img-fluid" alt="img">
                                                </a>
                                            </div>
                                        </div>
                                        <div class="fav-item">
                                    ...
                                    <div class="place-content">
                                        <div class="d-flex justify-content-between align-items-center flex-wrap row-gap-2 mb-3">
                                            <div>
                                                <h5 class="text-truncate mb-1"><a href="{{route('client.voyage.detail')}}">Antonov An-32</a></h5>
                                                <div class="d-flex">
                                        ...
                                        <div class="d-flex align-items-center justify-content-between border-top flex-wrap gap-2 pt-3">
                                            ...
                                            <a href="{{route('client.create.reservation')}}" class="btn btn-primary me-0">Reserver</a>
